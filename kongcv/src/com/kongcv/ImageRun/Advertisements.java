...
//	public View initView(final JSONArray advertiseArray){
	public View initView(final List<String> advertiseArray){	
		View view = inflater.inflate(R.layout.advert_image_point, null);
...
//		for(int i = 0 ; i < advertiseArray.length() ; i ++){
		for(int i = 0 ; i < advertiseArray.size() ; i ++){	
			...
			ll.addView(inflater.inflate(R.layout.advert_board_dot, null));
		}
		initDots(view , ll);
