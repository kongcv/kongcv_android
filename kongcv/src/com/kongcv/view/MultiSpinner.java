        ...
        public void onClick(View v) {
            ...
            if(checkBox.isChecked()){
               /* if(position>=6){
                    ...
                    Toast.makeText(MultiSpinner.this.getContext(), String.format("最多只能选择 %s 个", position), Toast.LENGTH_SHORT).show();
                    return;
                }*/
                checkedSet.add(op.getValue());
                Log.v("checkbox被点击了 value", op.getValue()+"");
                Log.v("checkbox被点击了 name", op.getName());
            }else{
