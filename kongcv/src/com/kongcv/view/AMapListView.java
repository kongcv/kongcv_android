...
import com.kongcv.R;
import com.kongcv.LinearLayout.XListViewFooter;
import com.kongcv.LinearLayout.XListViewHeader;
public class AMapListView extends ListView implements OnScrollListener {
	private float mLastY = -1; // save event y
	private Scroller mScroller; // 用于回滚
	private OnScrollListener mScrollListener; // 回滚监听
	// 触发刷新和加载更多接口.
	private AMapListViewListener mListViewListener;
	// -- 头部的View
	...
	public AMapListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public AMapListView(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setAMapListViewListener(AMapListViewListener listener) {
	 ...
	 * 实现这个接口来刷新/负载更多的事件
	 */
	public interface AMapListViewListener {
