...
import com.kongcv.activity.LogoActivity;
import com.kongcv.activity.SplashActivity;
...
public class UpdateService extends Service {
	...
	public void onStart(Intent intent, int startId) {
		...
		apkurl = intent.getStringExtra("UpdateApk");
	...
	public void onCreate() {
		...
		if (Environment.getExternalStorageState().equals(
			...
			apkPath = Environment.getExternalStorageDirectory()
					.getAbsolutePath() + "/kongcvuser";
			apkName = "kongcvuser.apk";
			registerBroader();
			setUpNotifiction();
	...
	private void setUpNotifiction() {
		...
		Intent intent ;
		if(activityCode==0){
			intent = new Intent(UpdateService.this, SplashActivity.class);
		}else{
			intent = new Intent(UpdateService.this, LogoActivity.class);
		}
